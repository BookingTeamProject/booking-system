...
export const HostAccommodationsPage: React.FC = () => {
  ...
  // Підтягуємо реальні броні з C# бекенду для кабінету хоста
  useEffect(() => {
  ...
  // Фільтрація бронювань для різних вкладок
  ...
  // Дії з заявками (Оновлення статусу на бекенді)
        ...
        <>
          ...
          {activeSubTab === 'properties' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                          <button
                            ...
                            onClick={() => navigate(`/routes/edit/${p.id}`)}
                          >
                            Редагувати
                          </button>
                          <button
              ...
              {/* Блок "Заявки на бронювання" - З РЕАЛЬНИМИ ДАНИМИ З БД */}
...
const paginationSquareBtnStyle: React.CSSProperties = { width: '36px', height: '36px', backgroundColor: 'white', border: '1px solid #D7C7B1', borderRadius: '8px', fontSize: '14px', fontWeight: 700, color: '#6E473B', cursor: 'pointer' };
...
const emptyIconCircleStyle: React.CSSProperties = { width: '64px', height: '64px', borderRadius: '32px', backgroundColor: 'rgba(220, 150, 102, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center' };
...
const infoNoticeBannerStyle: React.CSSProperties = { padding: '18px 24px', backgroundColor: 'rgba(220, 150, 102, 0.15)', borderRadius: '12px', border: '1px solid #DC9666', display: 'flex', alignItems: 'center', gap: '14px' };
...
const activePillOptionStyle: React.CSSProperties = { padding: '8px 14px', backgroundColor: 'rgba(220, 150, 102, 0.15)', color: '#DC9666', borderRadius: '6px', fontWeight: 700, fontSize: '13px' };
const inactivePillOptionStyle: React.CSSProperties = { padding: '8px 14px', border: '1px solid #D7C7B1', color: '#A78D78', borderRadius: '6px', fontSize: '13px' };
